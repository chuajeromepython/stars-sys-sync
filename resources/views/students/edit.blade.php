...
@section('content')
    ...
    {{-- <div class="container"> --}}
    <form method="post" action="/students/update" class="form">
        @csrf()
         <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" >
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                placeholder="Type first name here..." value="{{$person->first_name}}">
                            </div>
                            <div class="col-md-3">
                                <label class="text-muted">Middle Name</label>
                                <input type="text" class="form-control" name="middle_name" 
                                placeholder="Type middle name here..." value="{{$person->middle_name}}">
                            </div>
                            <div class="col-md-3">
                                <label class="text-muted">Last Name</label>
                                <input type="text" class="form-control" name="last_name" 
                                placeholder="Type last name here..." value="{{$person->last_name}}">
                            </div>
                            <div class="col-md-3">
                                <label class="text-muted">Suffix</label>
                                <input type="text" class="form-control" name="suffix"
                                placeholder="Type suffix here..." value="{{$person->suffix}}">
                            </div>
                            <div class="col-md-6">
