...
@section('content')
    ...
    {{-- <div class="container"> --}}
    <form method="post" action="/division_supervisors/update" class="form">
        @csrf()
         <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" >
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="id" value="{{$divisionSupervisor->id}}">
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="select2bs4 form-control" name="division" {{$attribute}}>
                                    @foreach($divisions as $division)
                                        <option value="{{$division->id}}"
                                            {{ ($division->id == $divisionSupervisor->division_id) ? 'selected' : ''}} >
                                            {{$division->name}}
                                        </option>
                                   @endforeach
                                </select>
