...
@section('content')
    ...
    {{-- <div class="container"> --}}
    <form method="post" action="/school_supervisors/update" class="form">
        @csrf()
         <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" >
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="id" value="{{$school_supervisor->id}}">
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="select2bs4 form-control" name="school_id">
                                    @foreach($schools as $school)
                                        <option value="{{$school->id}}"
                                            {{ ($school->id == $school_supervisor->school_id) ? 'selected' : ''}}
                                            > {{ $school->name }}</option>
                                    @endforeach
                                </select>
                            </div>
