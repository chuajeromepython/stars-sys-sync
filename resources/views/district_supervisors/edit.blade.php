...
@section('content')
    ...
    {{-- <div class="container"> --}}
    <form method="post" action="/district_supervisors/update" class="form">
        @csrf()
         <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body" >
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="id" value="{{$districtSupervisor->id}}">
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="select2bs4 form-control" name="district_id">
                                    @foreach($districts as $district)
                                        <option value="{{$district->id}}"
                                            {{ ($district->id == $districtSupervisor->district_id) ? 'selected' : ''}}
                                            > {{ $district->district }}, {{ $district->division }}</option>
                                    @endforeach
                                </select>
                            </div>
